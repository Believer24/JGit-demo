...
//                    .setRemote("origin").setRemoteBranchName("master").call();
    ...
    public synchronized static void pushCommand(String user, String password, File file) throws Exception {
        if(file != null) {
            ...
            Iterable<PushResult> list = git.push().setRemote("https://github.com/Believer24/JGit-demo").add("master").setCredentialsProvider(new UsernamePasswordCredentialsProvider("Believer24", "Zh19930315")).call();
            if(list != null) {
