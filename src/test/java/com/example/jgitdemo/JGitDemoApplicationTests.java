...
//            git.checkout().setName("dev").call();
            ...
            git.push().setRemote("https://github.com/Believer24/JGit-demo.git").add("dev").setCredentialsProvider( new UsernamePasswordCredentialsProvider("Believer24", "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")).call();
        }
    }
}
